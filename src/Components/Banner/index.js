                ...
                <div className="row-custom">
                    <div className="col-text">
                        ...
                        <div className="title-primary">
                            <h2>Hi, I’m <span class='text-red'>Anurag Hakeem</span></h2>
                        </div>
                        ...
                        <div className="row-custom social-links">
                            <div className="col-33">
                                <a class='social-button' href='https://www.linkedin.com/in/anuraghakeem/' target='_blank'>
                                    <img src={Linkedin}></img>
                                </a>
                            </div>
                            <div className="col-33">
                                <a class='social-button' href='https://github.com/anuraghakeem' target='_blank'>
                                    <img src={Github}></img>
                                </a>
                            </div>
                            <div className="col-33">
                                <a class='social-button' href='https://www.behance.net/anuraghakeem' target='_blank'>
                                    <img src={Behance}></img>
                                </a>
                            </div>
                        </div>
